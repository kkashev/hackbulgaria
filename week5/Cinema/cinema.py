...
class Cinema:
    ...
    def show_movies(self):
        self.cursor.execute('''SELECT name, rating FROM movies ORDER BY rating''')
...
def main():
    ...
    test_cinema.add_projection(1, "3D", "2014-04-01", "19:10")
    test_cinema.add_projection(1, "2D", "2014-04-01", "13:10")
    test_cinema.add_reservation("kashev", 1, 2, 2)
    test_cinema.add_reservation("ana", 1, 3, 3)
    test_cinema.show_movies()
